...
def load_loans():
    """Load loan data from staging to silver schema, handling insertions and updates."""
    try:
        ...
        logging.error(f'An error occurred while moving data from Loans to Dim_Loans: {e}')
        raise
